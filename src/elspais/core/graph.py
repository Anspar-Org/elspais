"""Unified traceability graph data structures.
...
class TraceNode:
    ...
    Attributes:
        ...
        children: Child nodes (populated during graph building).
...
@dataclass
class TraceGraph:
    """The complete traceability graph.
    ...
    def all_nodes(self, order: str = "pre") -> Iterator[TraceNode]:
        ...
        Yields:
            All TraceNode instances in the graph.
        """
    ...
    def accumulate(
        ...
        This method traverses the graph in post-order (children first),
