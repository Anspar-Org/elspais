...
def create_app(state: AppState, mount_mcp: bool = True, base_path: str = "") -> Starlette:
    ...
    routes: list[Route | Mount] = [
        ...
        Route("/api/mutate/add-declaration", api_mutate_add_declaration, methods=["POST"]),
        Route("/api/mutate/update-declaration", api_mutate_update_declaration, methods=["POST"]),
        Route("/api/mutate/rename-declaration", api_mutate_rename_declaration, methods=["POST"]),
        Route("/api/mutate/delete-declaration", api_mutate_delete_declaration, methods=["POST"]),
