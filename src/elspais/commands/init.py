...
def run(args: argparse.Namespace) -> int:
    ...
    sponsor_prefix = args.sponsor_prefix

    if project_type == "sponsor" and not sponsor_prefix:
        print("Error: --sponsor-prefix required for sponsor repositories")
        return 1

    # Generate configuration
    config_content = generate_config(project_type, sponsor_prefix)
...
def generate_config(project_type: str, sponsor_prefix: str = None) -> str:
    """Generate configuration file content."""

    if project_type == "sponsor":
        return f'''# elspais configuration - Sponsor Repository
# Generated by: elspais init --type sponsor

[project]
name = "{sponsor_prefix.lower()}-sponsor"
type = "sponsor"

[sponsor]
prefix = "{sponsor_prefix}"
id_range = [1, 99999]
...
allow_orphans = true  # More permissive for sponsor development
