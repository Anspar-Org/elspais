...
class TestParserConfig:
    ...
    def test_creation(self):
        ...
        from elspais.core.tree_schema import ParserConfig
...
class TestRelationshipSchema:
    ...
    def test_creation_minimal(self):
        ...
        from elspais.core.tree_schema import RelationshipSchema
...
class TestValidationConfig:
    ...
    def test_defaults(self):
        ...
        from elspais.core.tree_schema import ValidationConfig
...
class TestTreeSchema:
    """Tests for TreeSchema dataclass."""
    ...
    def test_validate_parser_patterns_with_overlap(self):
        ...
        from elspais.core.tree_schema import ParserConfig, TreeSchema
    ...
    def test_from_config_with_nodes(self):
        ...
        schema = TreeSchema.from_config(config)
    ...
    def test_merge_with(self):
        ...
        from elspais.core.tree_schema import NodeTypeSchema, RelationshipSchema, TreeSchema

        base = TreeSchema.default()

        extension = TreeSchema(
            node_types={
                "risk": NodeTypeSchema(
                    name="risk",
                    id_pattern="RISK-{id}",
...
class TestTreeSchemaIntegration:
    """Integration tests for TreeSchema with real config files."""
