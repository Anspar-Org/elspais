...
class TestTraceNode:
    ...
    def tree_with_hierarchy(self):
        ...
        Structure:
            ...
            └── child2 (OPS)
        """
        from elspais.core.tree import NodeKind, TraceNode
...
class TestTraceTree:
    """Tests for TraceTree dataclass."""

    @pytest.fixture
    def simple_tree(self, tmp_path):
        """Create a simple tree for testing."""
        from elspais.core.tree import NodeKind, TraceNode, TraceTree
        ...
        return TraceTree(roots=[root1, root2], repo_root=tmp_path)

    def test_creation(self, simple_tree, tmp_path):
        """Test creating TraceTree."""
    ...
    def test_accumulate_leaf_values(self, tmp_path):
        ...
        tree = TraceTree(roots=[root], repo_root=tmp_path)
...
class TestSupportingDataclasses:
    ...
    def test_code_reference(self):
        ...
        from elspais.core.tree import CodeReference
    ...
    def test_test_reference(self):
        ...
        from elspais.core.tree import TestReference
    ...
    def test_test_result(self):
        ...
        from elspais.core.tree import TestResult
    ...
    def test_user_journey(self):
        ...
        from elspais.core.tree import UserJourney
...
class TestTreeIntegration:
    ...
    def test_build_tree_from_requirements(self, hht_like_fixture):
        """Test building a tree from parsed requirements."""
        from elspais.config.loader import load_config
        from elspais.core.parser import RequirementParser
        from elspais.core.patterns import PatternConfig
        from elspais.core.tree import NodeKind, SourceLocation, TraceNode, TraceTree
        ...
        tree = TraceTree(roots=roots, repo_root=hht_like_fixture)
