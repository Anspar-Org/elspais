...
class TestComputeValidationColorCatalog:
    ...
    def test_REQ_p00006_A_green_description_from_catalog(self):
        ...
        # (REQ-d00289-F): the `full` standing -> green.
    ...
    def test_REQ_p00006_A_red_description_from_catalog(self):
        ...
        catalog = get_catalog()
        # A failing tier badges from the `failing` STANDING -> red (REQ-d00289-F),
        ...
        # tested denominator) -> relative 'failing' tier -> red (REQ-d00289-F).
        rollup = RollupMetrics(
            total_assertions=2,
    ...
    def test_REQ_p00006_A_yellow_description_from_catalog(self):
        ...
        # (REQ-d00289-F), never the severity's yellow-green.
...
class TestSeverityCatalog:
    """Test severity colors resolved through the theme catalog (REQ-d00290-A)."""
    ...
    # Verifies: REQ-d00258-T, REQ-d00289-A
    ...
    # Verifies: REQ-d00288-A+H, REQ-d00289-H
    ...
    # Verifies: REQ-d00288-A, REQ-d00289-H
