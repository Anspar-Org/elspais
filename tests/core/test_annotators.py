...
class TestGetImplementationStatus:
    ...
    def test_boundary_1_is_partial(self):
        ...
        node.set_metric(
            ...
            RollupMetrics(
                total_assertions=100,
                implemented=CoverageDimension(total=100, immediate_direct_by_label={"A": 1.0}),
            ),
        )
