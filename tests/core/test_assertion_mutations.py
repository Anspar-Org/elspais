...
class TestRenameAssertion:
    ...
    def test_rename_basic(self):
        """Basic rename updates assertion ID and label."""
...
class TestAddAssertion:
    ...
    def test_add_basic(self):
        """Basic add creates a new assertion."""
        graph = build_graph_with_assertions()
...
class TestDeleteAssertion:
    ...
    def test_delete_basic(self):
        """Basic delete removes assertion from index (with default compact)."""
        graph = build_graph_with_assertions()
