"""Tests for edge mutation operations (add_edge, change_edge_kind, delete_edge, fix_broken_reference)."""
...
class TestAddEdge:
    ...
    def test_add_edge_basic(self):
        """Basic add edge creates relationship."""
...
class TestChangeEdgeKind:
    ...
    def test_change_edge_kind_basic(self):
        """Basic change edge kind works."""
...
class TestDeleteEdge:
    ...
    def test_delete_edge_basic(self):
        """Basic delete edge removes relationship."""
        graph = build_hierarchy_graph()
...
class TestFixBrokenReference:
    ...
    def test_fix_broken_reference_basic(self):
        """Basic fix creates valid edge."""
    ...
    def test_fix_broken_reference_new_target_not_found(self):
        ...
        entry = graph.fix_broken_reference(
            "REQ-p00002", "REQ-nonexistent", "REQ-also-nonexistent"
        )
