...
class TestTreeCoverageBucket:
    """REQ-d00292-A: /api/tree-data coverage field uses severity-aware tier bucket."""
...
"""
    ...
    def full_indirect_client(self, tmp_path: Path) -> TestClient:
        ...
        color now resolves from the STANDING (missing -> grey, REQ-d00292-G),
    ...
    def test_tree_coverage_field_uses_tier_bucket(self, full_indirect_client: TestClient):
        ...
        # Color decoupled from severity (REQ-d00292-G): the journey-less UAT
