...
class TestRenameNode:
    ...
    def test_rename_basic(self):
        """Basic rename updates node ID and index."""
...
class TestUpdateTitle:
    ...
    def test_update_title_basic(self):
        """Basic title update works."""
        graph = build_simple_graph()
...
class TestChangeStatus:
    ...
    def test_change_status_basic(self):
        """Basic status change works."""
        graph = build_simple_graph()
...
class TestAddRequirement:
    ...
    def test_add_requirement_basic(self):
        """Basic add creates a new node."""
        graph = build_simple_graph()
...
class TestDeleteRequirement:
    ...
    def test_delete_requirement_basic(self):
        """Basic delete removes node from index."""
        graph = build_simple_graph()
