...
from elspais.graph import NodeKind, BrokenReference
...
class TestOrphanDetection:
    ...
    def test_no_orphans_when_all_linked(self):
        ...
        builder.add_parsed_content(make_req("REQ-o00001", "Child", "OPS", implements=["REQ-p00001"]))
    ...
    def test_orphan_with_broken_reference(self):
        ...
        builder = GraphBuilder()
        builder.add_parsed_content(make_req("REQ-p00001", "Parent", "PRD"))
        builder.add_parsed_content(make_req("REQ-o00001", "Broken child", "OPS", implements=["REQ-NONEXISTENT"]))
...
class TestBrokenReferenceDetection:
    ...
    def test_broken_ref_implements(self):
        ...
        builder = GraphBuilder()
        builder.add_parsed_content(make_req("REQ-o00001", "Broken", "OPS", implements=["REQ-NONEXISTENT"]))
    ...
    def test_broken_ref_refines(self):
        ...
        builder = GraphBuilder()
        builder.add_parsed_content(make_req("REQ-o00001", "Broken refines", "OPS", refines=["REQ-NONEXISTENT"]))
    ...
    def test_multiple_broken_refs(self):
        ...
        builder = GraphBuilder()
        builder.add_parsed_content(make_req("REQ-o00001", "First", "OPS", implements=["REQ-MISSING1"]))
        builder.add_parsed_content(make_req("REQ-o00002", "Second", "OPS", implements=["REQ-MISSING2"]))
...
class TestIntegration:
    ...
    def test_mixed_valid_and_broken(self):
        ...
        builder.add_parsed_content(make_req("REQ-o00001", "Valid Child", "OPS", implements=["REQ-p00001"]))
        builder.add_parsed_content(make_req("REQ-o00002", "Broken Child", "OPS", implements=["REQ-NONEXISTENT"]))
