...
class TestFormatSupportValidation:
    ...
    def test_REQ_d00085_E_health_supports_text_markdown_json(self):
        """Health section supports text, markdown, json."""
        assert FORMAT_SUPPORT["health"] == {"text", "markdown", "json"}
