...
- **Automatic sponsor bypass** -- Legacy `scan_sponsors` is automatically skipped when `[associates]` config is present, preventing double-loading of associate specs. Repos without `[associates]` continue using the old sponsor system unchanged.
