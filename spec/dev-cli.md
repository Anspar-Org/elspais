...
A. A report the viewer can show SHALL be exportable from the viewer as a document, in each document format the same report offers on the command line and as PDF wherever the report renders as markdown.
